														...
														UINT16 usLeft, UINT16 usTop, UINT16 usRight, UINT16 usBottom )
{
	...
	pCurr->usLtColor = Get16BPPColor( FROMRGB( (UINT8)(std::min)( (UINT16)255, (UINT16)(r*1.33)),
																						(UINT8)(std::min)( (UINT16)255, (UINT16)(g*1.33)),
																						(UINT8)(std::min)((UINT16) 255, (UINT16)(b*1.33)) ));
